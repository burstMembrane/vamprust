...
cmd_three="python3 python/examples/chordino.py"
mkdir -p benchmarks
hyperfine --warmup 3 "$cmd_one" "$cmd_two" "$cmd_three" --export-markdown benchmarks/shootout_${GIT_HASH_SHORT}_${BRANCH}.md
